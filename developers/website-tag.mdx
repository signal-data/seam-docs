...
From your Seam AI settings, copy the website tag snippet provided. Paste this snippet into the **HTML** field in Google tag manager. Once you’re done, click **Save** to finalize the setup.
...
Once the tag is in place, no additional setup is required. The Seam AI website tag will immediately begin capturing both page views and visitor identification data automatically.
