...
Navigate to **Fit Score → Add fit**. Configure the list of companies to include in the fit based using conditions.

Build the list of custom criteria using natural language prompts. Fit Score can answer questions that traditional data providers can't:
